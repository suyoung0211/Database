...
public class ResultSetTest {
    ...
    // level 로 조회
    // 같은 레벨(step) 값이 여러개 있으므로 조회 되는 행은 0 ~ 여러개
    public static void selectByLevel() {
    ...
    public static void selectByPk() {
        ...
        try (
            ...
            if (result) {
                System.out.println("##### 조회 결과 컬럼값 추력 #####");
                // rs.getXXXX(컬럼 인덱스) : XXXX 은 컬럼이 number 타입이면 Int, Double
                // char 또는 varchar2 타입이면 String
                System.out.println("번호 : " + rs.getInt(1));
                System.out.println("영어 단어 : " + rs.getString(2));
                System.out.println("한글 뜻 : " + rs.getString(3));
                System.out.println("레벨 : " + rs.getString(4));
