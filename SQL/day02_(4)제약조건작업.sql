/* 
    ...
    DBNS 는 사용자(개발자)가 만든 여러 테이블 등 여러 정보(메타데이터)를 저장하는 시스템 테이블이 있습니다.
    --> USER_CONSTRAINTS, USER_CONS_COLUMNS 테이블은 오라클이 만든 시스템 테이블
    🌟 '딕셔너리 뷰' 라고 부릅니다.
*/
...
-- WHERE TABLE_NAME = 'TBL_JAVAWORD'; 는 해당 테이블의 제약 조건이 없으므로 조회 결과가 없습니다.
...
CREATE TABLE tbl_javadict3 (
    ...
    CONSTRAINT chk_javadict3_kor CHECK (KOREAN IS NOT NULL),
