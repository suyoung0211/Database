...
-- 			   0.0001 (모든 0 이 유효함)	0.00100 (1 뒤에 0 2개는 유효 숫자가 아님)
...
INSERT INTO tbl_number(ycol) values (12345.789); 	-- 12346 소수점 이하 반올림
...
INSERT INTO TBL_NUMBER(zcol) values (1.245454);		-- 1.25 반올림해서 소수점 둘째자리까지 표시
INSERT INTO TBL_NUMBER(zcol) values (123456.454);	-- 오류

-- zcol2 NUMBER(2,5)  : 소수점 이하 자리수 항상 5개,
-- 5-2 = 3 은 유효한 0의 갯수(고정값) => 0.000 form 고정
